package com.wl.weblog.web.config;
...
public class Knife4jConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.wl.weblog.web.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("犬小哈", "https://www.quanxiaoha.com", "1787986639@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}
