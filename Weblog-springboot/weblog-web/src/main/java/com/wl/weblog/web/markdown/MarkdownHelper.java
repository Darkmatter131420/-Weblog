package com.wl.weblog.web.markdown;

import com.wl.weblog.web.markdown.provider.NofollowLinkAttributeProvider;
import com.wl.weblog.web.markdown.renderer.ImageNodeRenderer;
...
public class MarkdownHelper {
    ...
    static {
        ...
        List<Extension> extensions = Arrays.asList(
                ...
                ImageAttributesExtension.create(), //图片属性
