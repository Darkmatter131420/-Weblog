...
import com.wl.weblog.web.markdown.MarkdownHelper;
import com.wl.weblog.web.model.vo.article.*;
import com.wl.weblog.web.model.vo.category.FindCategoryListRspVO;
import com.wl.weblog.web.model.vo.tag.FindTagListRspVO;
import com.wl.weblog.web.service.ArticleService;
...
public class ArticleServiceImpl implements ArticleService {
    ...
    public Response findArticlePageList(FindIndexArticlePageListReqVO findIndexArticlePageListReqVO) {
        ...
        if (!CollectionUtils.isEmpty(articleDOS)) {
            // 文章 DO 转 VO
            vos = articleDOS.stream().map(ArticleConvert.INSTANCE::convertDO2VO)
    ...
    public Response findArticleDetail(FindArticleDetailReqVO findArticleDetailReqVO) {
        ...
        List<FindTagListRspVO> findTagListRspVOS = tagDOS.stream()
